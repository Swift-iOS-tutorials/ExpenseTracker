...
extension Category {
    static let automAndTransportation = Category(id: 1, name: "Auto & Transportation", icon: .car_alt)
    static let billsAndUrilities = Category(id: 2, name: "Bills & Utilities", icon: .file_invoice_dollar)
    static let entertament = Category(id: 3, name: "Entertament", icon: .film)
    ...
    static let finanaceCharge = Category(id: 402, name: "Finanace Charge", icon: .hand_holding_usd, mainCategoryId: 4)
...
extension Category{
    ...
    static let all: [Category] = subCategories + subCategories
